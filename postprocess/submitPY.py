if __name__ == '__main__':
	...
	for keys_t in Temps:
					...
					#--- write to
					inums = lnums[ 0 ] - 1
					string[ inums ] = "\t19:\'%sNatom100KMultipleTempIrradiatedAnneal/benchmark/temp%s\',\n"%(alloy,keys_t) #--- change job name

					inums = lnums[ 1 ] - 1
					string[ inums ] =  "\t19:\'/../lammpsRuns/%sNatom100KMultipleTempIrradiatedAnneal/benchmark/temp%s\',\n"%(alloy,keys_t)
