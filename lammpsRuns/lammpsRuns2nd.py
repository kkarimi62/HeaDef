...
if __name__ == '__main__':
	...
	Variable = {
				...
				7:' -var buff 0.0 -var T 1.0 -var P 0.0 -var nevery 1000 -var ParseData 1 -var DataFile data_minimized.txt -var DumpFile dumpThermalized.xyz -var WriteData Equilibrated_0.dat',
				8:' -var buff 0.0 -var T 1.0 -var sigm 0.4 -var sigmdt 0.06 -var ndump 400 -var ParseData 1 -var DataFile Equilibrated_0.dat -var DumpFile dumpSheared.xyz',
