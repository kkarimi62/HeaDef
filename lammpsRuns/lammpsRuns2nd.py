...
if __name__ == '__main__':
	...
	Variable = {
				...
				5:' -var DataFile data.txt -var buff 6.0 -var DumpFile dumpMin.xyz -var nevery 1000 -var WriteData data_minimized.txt -var INC %s'%(SCRPT_DIR), 
				7:' -var buff 6.0 -var T 0.1 -var DataFile data_minimized.txt -var DumpFile dumpThermalized.xyz -var WriteData Equilibrated_300.dat -var INC %s'%(SCRPT_DIR),
				8:' -var buff 6.0 -var T 0.1 -var DataFile Equilibrated_300.dat -var DumpFile dumpSheared.xyz -var INC %s'%(SCRPT_DIR),
