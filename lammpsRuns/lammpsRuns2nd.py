...
if __name__ == '__main__':
	...
	Variable = {
				...
				5:' -var buff 5.0 -var buffy 0.0 -var nevery 1000 -var ParseData 1 -var DataFile data.txt -var DumpFile dumpMin.xyz -var WriteData data_minimized.txt', 
				7:' -var buff 0.0 -var buffy 0.0 -var T 600.0 -var P 0.0 -var nevery 1000 -var ParseData 1 -var DataFile data_minimized.txt -var DumpFile dumpThermalized.xyz -var WriteData Equilibrated_600.dat',
				...
				8:' -var buff 0.0 -var buffy 0.0 -var T 0.1 -var sigm 1.0 -var sigmdt 0.0001 -var ndump 100 -var ParseData 1 -var DataFile Equilibrated_0.dat -var DumpFile dumpSheared.xyz',
				...
				'p3':' %s 3.52 10.0 20.0 40.0 data.txt'%(os.getcwd()+'/../postprocess'),
				} 
	...
	indices = {
				...
				5:['p3',5], #--- put disc. by atomsk, minimize, thermalize, and shear
			  }[5]
