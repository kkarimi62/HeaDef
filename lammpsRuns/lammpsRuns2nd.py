...
if __name__ == '__main__':
	...
	nNode	 = 1
	#
	jobname  = ['NiNatom100KReplaceCoRlxd','NiCoCrNatom100KTemp300', 'NiCoCrT0EdgeDisl', 'NiCoCrNatom1000KEdgeDisl', 'NiCoCrNatom200KTemp600Annealed', 'NiCoCrNatom100KTemp300Gdot4' ][-1]
	sourcePath = os.getcwd() +\
				['/../postprocess/NiCoCrNatom1K','/NiCoCrNatom100K','/NiCoCrNatom100KTemp300','/junk','/../postprocess/NiNatom1K','/../postprocess/NiCoCrNatom1K', '/../postprocess/NiCoCrNatom1000K', '/NiCoCrNatom200KTemp600'][2] #--- must be different than sourcePath
        #
        sourceFiles = [['Equilibrated_300.dat'],['data.txt','ScriptGroup.txt'],['data.txt']][0] #--- to be copied from the above directory
	#
	...
	#
	LmpScript = ['Ni/relax.in', 'Ni/relaxWalls.in', 'NiCoCr/relax.in','NiCoCr/Thermalization.lmp', 'NiCoCr/vsgc.lmp', 'Ni/minimization_edge.lmp','NiCoCr/minimization_edge.lmp', 'NiCoCr/shearDispTemp.in'][-1] #--- [pbc, rigid walls,] 
	Variables = [' -var T 300 -var DataFile Equilibrated_300.dat',' -var buff 6.0 -var nevery 10'][0] 
	#
